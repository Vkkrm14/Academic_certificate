...
export default function FinancePage() {
    ...
    const checkFinanceRole = async () => {
      ...
      try {
        const result = await readContract({
          ...
          method: "function isFinance(address) view returns (bool)",
          params: [account.address],
        });
        setIsFinance(result as boolean);
      } catch (error) {
  ...
  // Load current pending approvals (students pending Finance approval)
  const loadCurrentPending = useCallback(async () => {
    if (!isFinance || isLoadingRef.current || dataLoadedRef.current.current)
      return;
  ...
  }, [isFinance, certificateContract]);

  // Load all pending approvals at all levels
  const loadAllLevelPending = useCallback(async () => {
    if (!isFinance || isLoadingRef.current || dataLoadedRef.current.allLevels)
      return;
  ...
  const loadIssuedCertificates = useCallback(async () => {
    if (!isFinance || isLoadingRef.current || dataLoadedRef.current.issued)
      return;
    ...
    try {
      ...
      const issuedList: IssuedCertificate[] = records.map((record: any) => ({
        ...
        financeVerifier: safeToString(record.financeVerifier || record[22]),
      }));
  ...
  const handleApprove = async (regNo: string) => {
    if (!account || !isFinance) {
      alert("Only Finance accounts can approve students");
      return;
    }
    ...
    try {
      ...
      const transaction = prepareContractCall({
        contract: certificateContract,
        method: "function approveByFinance(string memory regNo) public",
        params: [regNo],
      });
      ...
      sendTransaction(transaction, {
        onSuccess: () => {
          alert(
            `Student ${regNo} approved successfully! Moving to Registrar level.`,
          );
  ...
  const handleReject = async () => {
    if (!account || !isFinance || !rejectRegNo || !rejectReason) {
    ...
    try {
      ...
      const transaction = prepareContractCall({
        contract: certificateContract,
        method:
          "function rejectByFinance(string memory regNo, string memory reason) public",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 to-yellow-900 p-8">
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <Link
              href="/"
              className="text-orange-200 hover:text-white mb-2 inline-block"
            >
              ← Back to Home
            </Link>
            <h1 className="text-4xl font-bold text-white">Finance Dashboard</h1>
            <p className="text-orange-200">
              Third level approval - Review financial clearance
            </p>
          </div>
          ...
          <div className="text-center py-20">
            <div className="glass-effect rounded-lg p-8">
              ...
              <p className="text-gray-300">
                Please connect your wallet with Finance role to access this
                dashboard
              </p>
            </div>
          </div>
          ...
          <div className="text-center py-20">
            <div className="bg-red-500/20 backdrop-blur-md rounded-lg p-8 border border-red-500/50">
              ...
              <p className="text-red-300">
                Only accounts with Finance role can access this page
              </p>
          ...
          <>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-semibold transition-colors ${
                    activeTab === "current"
                      ...
                      : "glass-effect text-orange-200 hover:bg-white/20"
                  }`}
                >
              ...
              <button
                ...
                className="bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-600 text-white px-4 py-3 rounded-lg font-semibold"
              >
                🔄 Refresh
              </button>
            </div>
            ...
            {activeTab === "current" && (
              <div className="glass-effect rounded-lg p-8">
                <h2 className="text-2xl font-bold text-white mb-6">
                  Students Pending Finance Clearance
                </h2>
                ...
                {isLoadingDetails ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-gray-300 text-xl">
                      ✅ No pending financial clearance
                    </p>
                  </div>
                ) : (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-purple-400 font-mono text-xs">
                              {student.deanVerifier.slice(0, 10)}...
                            </p>
                          </div>
                          ...
                          <div className="flex flex-col justify-between items-end">
                            ...
                            <div className="flex gap-3 mt-4">
                              <button
                                ...
                                disabled={isLoading}
                                className="bg-orange-600 hover:bg-orange-700 disabled:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-semibold"
                              >
                                ✓ Clear Finance
                              </button>
                              <button
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
            <div className="bg-gray-900 rounded-lg p-8 max-w-md w-full mx-4 border border-red-500/50">
              ...
              <textarea
                ...
                placeholder="Enter reason for rejection (e.g., Outstanding fees, Financial discrepancy)..."
